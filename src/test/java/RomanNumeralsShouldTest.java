...
public class RomanNumeralsShouldTest {
    ...
    public void testRomanConvert() {
       ...
       assertEquals("DCCLXXII", RomanNumerals.convertRoman(SEVENHUNDREDSEVENTYTWO));
       ...
       assertEquals("MCDL", RomanNumerals.convertRoman(ONETFOURHFIFTY));
       assertEquals("MDLXXIII", RomanNumerals.convertRoman(ONETFIVEHSEVENTYTHREE));
        assertEquals("MDCCXXXVI", RomanNumerals.convertRoman(ONETSEVENHTHIRTYSIX));
        assertEquals("MDCCCXC", RomanNumerals.convertRoman(ONETEIGHTHNINETY));
       assertEquals("MCMXX", RomanNumerals.convertRoman(ONETNINEHTWENTY));
        assertEquals("MM", RomanNumerals.convertRoman(TWOTHOUSAND));
        assertEquals("MMCLXXXIII", RomanNumerals.convertRoman(TWOTONEHEIGHTYTHREE));
       assertEquals("MMCCXCII", RomanNumerals.convertRoman(TWOTTWOHNINETYTWO));
       assertEquals("MMCDXXV", RomanNumerals.convertRoman(TWOTFOURHTWENTYFIVE));
       assertEquals("MMDLV", RomanNumerals.convertRoman(TWOTFIVEHFIFTYFIVE));
        assertEquals("MMDCCXLIII", RomanNumerals.convertRoman(TWOTSEVENHFOURTYTHREE));
       assertEquals("MMCMI", RomanNumerals.convertRoman(TWOTNINEHANDONE));
        assertEquals("MMM", RomanNumerals.convertRoman(THREETHOUSAND));
